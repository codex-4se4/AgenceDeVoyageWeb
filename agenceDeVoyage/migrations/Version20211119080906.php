 ...
 */
final class Version20211119080906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD title VARCHAR(255) NOT NULL, ADD idr INT NOT NULL, ADD objet VARCHAR(255) NOT NULL, ADD user VARCHAR(255) NOT NULL, ADD discription VARCHAR(255) DEFAULT NULL, ADD contratdebut DATE NOT NULL, DROP objet_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD objet_id INT DEFAULT NULL, DROP title, DROP idr, DROP objet, DROP user, DROP discription, DROP contratdebut');
